...
| Benchmark (windowed) | `benchmark_windowed` | 10 000 citizens with PBR rendering, auto-exits after N frames        |
...
PillLauncher -a run -p examples/city --features benchmark_windowed
...
In `bench.rs`, rendering code is gated behind `#[cfg(feature = "benchmark_windowed")]`.

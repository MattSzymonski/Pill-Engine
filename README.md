<p align="left">
  <img src="media/pill_logo.png" img width=30%>
</p>
...
2. Download and unpack Pill Engine
3. Build Pill Launcher `cargo build --release --manifest-path <ENGINE-PATH>\Pill-Engine\crates\pill_launcher\Cargo.toml`
4. Add Pill Launcher to PATH (optional) `set PATH=%PATH%;<ENGINE-PATH>\Pill-Engine\crates\pill_launcher\target\release`
